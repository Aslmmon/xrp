...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private static final String PAYOUT_TYPE="com.pinxrp.xrp.PAYOUT_NOTIFICATION";
    private static final String REFER_TYPE="com.pinxrp.xrp.REFER_NOTIFICATION";
    private static final String REVIEW_TYPE="com.pinxrp.xrp.REVIEW_NOTIFICATION";
    int PRIVATE_MODE = 0;
